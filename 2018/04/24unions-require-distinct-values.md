...
And here is my sql to break the values
    ...
    UPDATE `andbeyond_reports`.`units_2018_01_01` SET `days_on_market` = '1' WHERE `unit_id` = 229;
    UPDATE `andbeyond_reports`.`units_2018_02_01` SET `days_on_market` = '2' WHERE `unit_id` = 229;
    UPDATE `andbeyond_reports`.`units_2018_03_01` SET `days_on_market` = '3' WHERE `unit_id` = 229;
    UPDATE `andbeyond_reports`.`units_2018_04_01` SET `days_on_market` = '4' WHERE `unit_id` = 229;

UPDATE `andbeyond_reports`.`units_2018_01_01` SET `days_on_market` = '1' WHERE `unit_id` = 229;    UPDATE `andbeyond_reports`.`units_2018_02_01` SET `days_on_market` = '2' WHERE `unit_id` = 229;    UPDATE `andbeyond_reports`.`units_2018_03_01` SET `days_on_market` = '3' WHERE `unit_id` = 229;    UPDATE `andbeyond_reports`.`units_2018_04_01` SET `days_on_market` = '4' WHERE `unit_id` = 229;
